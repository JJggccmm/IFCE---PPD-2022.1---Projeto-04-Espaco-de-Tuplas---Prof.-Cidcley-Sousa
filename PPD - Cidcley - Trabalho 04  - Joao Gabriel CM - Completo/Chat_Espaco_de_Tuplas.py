...
def janela_Inicial():
    ...
    cria_usuario_button = Button(newWindow, image=img_botao_gerar_Usuario_asset,command=lambda:janela_Config_Usuario(0,""))
        ...
        if (nome_usuario in usuarios):
            ...
            if(nome_sala_chat!=""):
                ...
                if (nome_sala_chat in salas):
                    ...
                    janela_Chat_Geral_Usuario(nome_usuario,nome_sala_chat)
                else:
...
def janela_Chat_Geral_Usuario(nome_usuario,nome_sala_chat):
    ...
    #newWindow.after(1,lambda:recebe_mensagens(newWindow,text_area,nome_usuario,nome_sala_chat))
...
def recebe_mensagens(ScrolledText,nome_usuario,salaAtual):
    ...
    while(True):
        if flag_Monitora_Novas_Mensagens == 1:
            ...
            if(msg_recebida[0][0] == "Todos"):
                ...
                print(nome_usuario+" recebeu a msg!")
    ...
    #newWindow_input.after(1000,lambda:recebe_mensagens(newWindow_input,ScrolledText,nome_usuario,salaAtual))
